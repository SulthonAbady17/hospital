                        ...
                        <form class="user" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="referral_letter"
                                        name="referral_letter" required>
                                    <label class="custom-file-label" for="referral_letter">Pilih file</label>
                                    <small>*.pdf (2MB)</small>
                                    <p>File saat ini: {{ basename($application->referral_letter_path) }}</p>
                                </div>
                                @error('referral_letter_path')
