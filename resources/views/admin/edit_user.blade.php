        ...
        <div class="card-body p-0">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="p-5">
                        <div class="">
                            <h1 class="h4 text-gray-900 mb-4">Edit Akun Pengguna/Verifikator Baru</h1>
                        </div>
                        @if (session('success'))
                        ...
                        <form class="user" method="POST" action="{{ route('admin.users.update', $user->id) }}">
                            ...
                            <div class="form-group">
                                <input type="text"
                                    ...
                                    id="name" placeholder="Nama Langkap" name="name" autocomplete="name"
                            ...
                            <div class="form-group">
                                <input type="email"
                                    ...
                                    name="email" id="email" placeholder="Alamat Email" value="{{ $user->email }}"
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="role" name="role" required>
                                    ...
                                    <option value="v1" {{ $user->role == 'v1' ? 'selected' : '' }}>
                                        Verifikator 1</option>
                                    <option value="v2" {{ $user->role == 'v2' ? 'selected' : '' }}>
